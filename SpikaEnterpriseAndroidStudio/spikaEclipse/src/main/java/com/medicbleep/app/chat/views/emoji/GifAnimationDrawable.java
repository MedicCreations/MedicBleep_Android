...
public class GifAnimationDrawable extends AnimationDrawable
{
	...
	public GifAnimationDrawable(File f, Context c) throws IOException
	{
		this(f, false, c);
	}
	
	public GifAnimationDrawable(InputStream is, Context c) throws IOException
	{
		this(is, false, c);
	}
	
	public GifAnimationDrawable(File f, boolean inline, Context c) throws IOException
	{
	    this(new BufferedInputStream(new FileInputStream(f), 32768), inline, c);
	}
	
	public GifAnimationDrawable(InputStream is, boolean inline, Context c) throws IOException
	{
		super();
		this.c = c;
		InputStream bis = is;

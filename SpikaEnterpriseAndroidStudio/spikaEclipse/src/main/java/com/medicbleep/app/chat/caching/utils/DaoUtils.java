package com.medicbleep.app.chat.caching.utils;

import java.util.ArrayList;
import java.util.List;

import com.medicbleep.app.chat.models.Category;
...
import com.medicbleep.app.chat.models.greendao.UserDetails;

public class DaoUtils {

	public static Chat convertDaoChatToChatModel(com.medicbleep.app.chat.models.greendao.Chat chat) {
	...
	private static List<Message> convertDaoListMessage(List<com.medicbleep.app.chat.models.greendao.Message> messageList) {
		List<Message> finalList = new ArrayList<Message>();
		for (com.medicbleep.app.chat.models.greendao.Message item : messageList) {
			finalList.add(convertDaoMessageToMessageModel(item));
		}
		return finalList;
	}

	public static Category convertDaoCategoryToCategoryModel(com.medicbleep.app.chat.models.greendao.Category category) {
	...
	public static User convertDaoUserToUserModel(com.medicbleep.app.chat.models.greendao.User user) {
	...
	public static Message convertDaoMessageToMessageModel(com.medicbleep.app.chat.models.greendao.Message message) {
	...
	public static List<Message> converDaoMessagesToMessagesModel(List<com.medicbleep.app.chat.models.greendao.Message> messages) {

		List<Message> newMessList = new ArrayList<Message>();
		for (com.medicbleep.app.chat.models.greendao.Message item : messages) {
	...
	public static Group convertDaoGroupToGroupModel(com.medicbleep.app.chat.models.greendao.Groups group) {
	...
	public static com.medicbleep.app.chat.models.greendao.Chat convertChatModelToChatDao(
			com.medicbleep.app.chat.models.greendao.Chat chatDao, Chat chat, long finalCategoryModelId, long finalUserModelId,
	...
	public static com.medicbleep.app.chat.models.greendao.Message convertMessageModelToMessageDao(
			com.medicbleep.app.chat.models.greendao.Message messageDao, Message message, int chatId) {
		...
		if (messageDao != null) {
			...
			messageDao = new com.medicbleep.app.chat.models.greendao.Message(Long.valueOf(message.id), Long.valueOf(message.chat_id),
	...
	public static com.medicbleep.app.chat.models.greendao.User convertUserModelToUserDao(
			com.medicbleep.app.chat.models.greendao.User userDao, User user) {
		...
		if (userDao != null) {
			...
			userDao = new com.medicbleep.app.chat.models.greendao.User((long) user.getId(), user.firstname, user.lastname, user.type,
	...
	public static com.medicbleep.app.chat.models.greendao.Organization convertOrganizationModelToOrganizationDao(
			com.medicbleep.app.chat.models.greendao.Organization organizationDao, Organization organization) {
		...
		if (organizationDao != null) {
			...
			organizationDao = new com.medicbleep.app.chat.models.greendao.Organization((Long.valueOf(organization.id)), organization.name);
		}

		return organizationDao;
	}

	public static com.medicbleep.app.chat.models.greendao.Category convertCategoryModelToCategoryDao(
			com.medicbleep.app.chat.models.greendao.Category categoryDao, Category category) {

		if (categoryDao == null) {
			categoryDao = new com.medicbleep.app.chat.models.greendao.Category(Long.valueOf(category.id), category.name);
		}

		return categoryDao;
	}

	public static com.medicbleep.app.chat.models.greendao.Groups convertGroupModelToGroupDao(
			com.medicbleep.app.chat.models.greendao.Groups groupDao, Group group) {
		...
		if (groupDao != null) {
			...
			groupDao = new com.medicbleep.app.chat.models.greendao.Groups(group.id, group.type, group.groupname, group.image,
	...
	public static Organization convertDaoOrganizationToOrganizationModel(com.medicbleep.app.chat.models.greendao.Organization daoOrganization) {

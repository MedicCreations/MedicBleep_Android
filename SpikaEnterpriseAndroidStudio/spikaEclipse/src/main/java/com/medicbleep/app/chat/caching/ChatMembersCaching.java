...
import com.medicbleep.app.chat.models.greendao.ChatMembers;
import com.medicbleep.app.chat.models.greendao.ChatMembersDao;
	...
	private static List<GlobalModel> getDBData(Activity activity, String chatId) {
		...
		if (activity instanceof BaseActivity) {
			...
			ChatMembers chatMembers = chatMembersDao.queryBuilder()
					.where(com.medicbleep.app.chat.models.greendao.ChatMembersDao.Properties.Id.eq(Integer.valueOf(chatId))).build()
					.unique();
			...
			if (chatMembers != null) {
				...
				try {
					...
					for (int i = 0; i < users.length(); i++) {
						...
						com.medicbleep.app.chat.models.greendao.User user = userDao.queryBuilder()
								.where(com.medicbleep.app.chat.models.greendao.UserDao.Properties.Id.eq(Integer.valueOf(value))).unique();
					...
					for (int i = 0; i < groups.length(); i++) {
						...
						com.medicbleep.app.chat.models.greendao.Groups group = groupsDao.queryBuilder()
								.where(com.medicbleep.app.chat.models.greendao.GroupsDao.Properties.Id.eq(Integer.valueOf(value))).unique();
					...
					for (int i = 0; i < chats.length(); i++) {
						...
						QueryBuilder<com.medicbleep.app.chat.models.greendao.Chat> qb = chatDao.queryBuilder();
						...
						com.medicbleep.app.chat.models.greendao.Chat chat = qb.build().unique();

...
import com.medicbleep.app.chat.webrtc.LooperExecutor;
import com.medicbleep.app.chat.webrtc.WebSocketChannelClient;
import com.medicbleep.app.chat.webrtc.autobahn.WebSocketConnection;
import com.medicbleep.app.chat.webrtc.autobahn.WebSocketConnectionHandler;
import com.medicbleep.app.chat.webrtc.autobahn.WebSocketException;
import com.medicbleep.app.chat.webrtc.socket.models.CallMessage;
import com.medicbleep.app.chat.webrtc.socket.models.CheckAvailableRoom;
import com.medicbleep.app.chat.webrtc.socket.models.SocketParser;
...
public class SocketService extends Service {
	...
	private boolean isActiveApp() {
		...
		if (Utils.isBuildOver(Build.VERSION_CODES.KITKAT_WATCH)) {
			...
			isActive = componentInfo.getPackageName().equalsIgnoreCase("com.medicbleep.app.chat");
		}

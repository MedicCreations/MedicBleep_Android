...
package com.medicbleep.app.chat.views.cropper;
...
import com.medicbleep.app.chat.views.cropper.cropwindow.CropOverlayView;
import com.medicbleep.app.chat.views.cropper.cropwindow.edge.Edge;
import com.medicbleep.app.chat.views.cropper.util.ImageViewUtil;
...
public class CropImageView extends FrameLayout {
	...
	private void init(Context context) {
		...
		mImageView = (TouchImageView) v.findViewById(R.id.ImageView_image);

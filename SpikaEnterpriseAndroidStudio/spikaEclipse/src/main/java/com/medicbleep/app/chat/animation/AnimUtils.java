package com.medicbleep.app.chat.animation;
...
public class AnimUtils {
	...
	public static void rotationInfinite(View view, boolean clockwise, long cycleDuration) {
	...
	public static void scaleX(final View view, final float from, final float to, final int duration, AnimatorListenerAdapter listener) {
	...
	public static void scaleY(final View view, final float from, final float to, final int duration, AnimatorListenerAdapter listener) {
	...
	public static void scaleShape(final View view, final float from, final float to, final int duration, AnimatorListenerAdapter listener) {
		scaleX(view, from, to, duration, listener);
		scaleY(view, from, to, duration, listener);
	}

	public static AnimatorSet goToLeftThenToRightAndBackInPosition(final View view, final int offset, final int duration, AnimatorListenerAdapter listener) {

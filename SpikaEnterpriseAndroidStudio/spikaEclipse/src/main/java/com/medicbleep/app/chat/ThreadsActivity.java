...
import com.medicbleep.app.chat.adapters.ThreadsAdapter;
...
import com.medicbleep.app.chat.caching.robospice.ThreadCacheSpice;
...
import com.medicbleep.app.chat.listeners.OnCheckEncryptionListener;
...
import com.medicbleep.app.chat.models.TreeNode;
...
public class ThreadsActivity extends BaseChatActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener, OnThreadDBChanged, OnThreadNetworkResult {
	...
	private void addNewMessage(SendMessageResponse result) {
		...
		com.medicbleep.app.chat.models.greendao.Message messDao = DaoUtils.convertMessageModelToMessageDao(null, result.message_model, Integer.valueOf(result.message_model.chat_id));

...
package com.clover.spika.enterprise.chat.views.cropper.util;
...
public class ImageViewUtil {
	...
	public static Rect getBitmapRectCenterInside(Bitmap bitmap, View view) {
		...
		// return getBitmapRectCenterInsideHelper(bitmapWidth, bitmapHeight,
		// viewWidth, viewHeight);
		return getBitmapRectMatchParentHelper(bitmapWidth, bitmapHeight, viewWidth, viewHeight);
	}

	public static Rect getBitmapRectMatchParent(Bitmap bitmap, View view) {
	...
	public static Rect getBitmapRectMatchParent(int bitmapWidth, int bitmapHeight, int viewWidth, int viewHeight) {
		return getBitmapRectMatchParentHelper(bitmapWidth, bitmapHeight, viewWidth, viewHeight);
	}
	...
	private static Rect getBitmapRectMatchParentHelper(int bitmapWidth, int bitmapHeight, int viewWidth, int viewHeight) {
		double resultWidth;
		double resultHeight;
		int resultX;
		int resultY;

		...
		new UserApi().inviteUsers(chatId, users.toString(), this, new ApiCallback<Chat>() {
			...
			public void onApiResponse(Result<Chat> result) {
				if (result.isSuccess()) {
					...
					ChatActivity.startWithChatId(InvitePeopleActivity.this, String.valueOf(result.getResultData().getId()), result.getResultData().getPassword(), result.getResultData().getUser());
					finish();
				} else {

 ...
 */
public class GifAnimationDrawableBACKUP extends AnimationDrawable
{
	...
	public GifAnimationDrawableBACKUP(File f, Context c) throws IOException
	{
		this(f, false, c);
	}
	
	public GifAnimationDrawableBACKUP(InputStream is, Context c) throws IOException
	{
		this(is, false, c);
	}
	
	public GifAnimationDrawableBACKUP(File f, boolean inline, Context c) throws IOException
	{
	    this(new BufferedInputStream(new FileInputStream(f), 32768), inline, c);
	}
	
	public GifAnimationDrawableBACKUP(InputStream is, boolean inline, Context c) throws IOException
	{
		super();
		this.c = c;
		InputStream bis = is;
        ...
        addFrame(new BitmapDrawable(c.getResources(), mTmpBitmap), mGifDecoder.getDelay(0));
	...
	private Runnable loader = new Runnable(){
		public void run() 
		{
	        ...
	        for(i=1;i<n;i++){
	            ...
	            addFrame(new BitmapDrawable(c.getResources(), mTmpBitmap), t);
	        }
	        decoded = true;
	        mGifDecoder = null;
	    }

...
import jp.co.vector.chat.GroupListActivity;
import jp.co.vector.chat.model.Push;
import jp.co.vector.chat.utils.Const;
import jp.co.vector.chat.utils.Helper;
import jp.co.vector.chat.utils.Logger;
import jp.co.vector.chat.utils.Preferences;
...
public class BaseActivity extends FragmentActivity {
	...
	new BaseAsyncTask<Void, Void, Integer>(this, false) {
		...
		final View view = LayoutInflater.from(instance).inflate(R.layout.in_app_notification_layout, null);
		...
		((ViewGroup) findViewById(android.R.id.content).getRootView()).addView(view, params);

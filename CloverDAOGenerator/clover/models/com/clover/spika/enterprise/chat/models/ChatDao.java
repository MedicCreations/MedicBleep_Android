...
public class ChatDao extends AbstractDao<Chat, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Chat_id = new Property(1, Integer.class, "chat_id", false, "CHAT_ID");
        ...
        public final static Property UserIdProperty = new Property(15, Long.class, "userIdProperty", false, "USER_ID_PROPERTY");
        public final static Property MessageIdProperty = new Property(16, Long.class, "messageIdProperty", false, "MESSAGE_ID_PROPERTY");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'CHAT' (" + //
                ...
                "'USER_ID_PROPERTY' INTEGER," + // 15: userIdProperty
                "'MESSAGE_ID_PROPERTY' INTEGER);"); // 16: messageIdProperty
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Chat entity) {
        ...
        Integer chat_id = entity.getChat_id();
        if (chat_id != null) {
    ...
    public Chat readEntity(Cursor cursor, int offset) {
        Chat entity = new Chat( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1), // chat_id
            ...
            cursor.isNull(offset + 15) ? null : cursor.getLong(offset + 15), // userIdProperty
            cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16) // messageIdProperty
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Chat entity, int offset) {
        ...
        entity.setChat_id(cursor.isNull(offset + 1) ? null : cursor.getInt(offset + 1));
        ...
        entity.setUserIdProperty(cursor.isNull(offset + 15) ? null : cursor.getLong(offset + 15));
        entity.setMessageIdProperty(cursor.isNull(offset + 16) ? null : cursor.getLong(offset + 16));
     }
    
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(Chat entity, long rowId) {
        return entity.getId();
    }

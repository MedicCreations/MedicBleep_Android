...
public class MessageDao extends AbstractDao<Message, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Chat_id = new Property(1, String.class, "chat_id", false, "CHAT_ID");
    ...
    public Message readEntity(Cursor cursor, int offset) {
        Message entity = new Message( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // chat_id
    ...
    public void readEntity(Cursor cursor, Message entity, int offset) {
        ...
        entity.setChat_id(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
